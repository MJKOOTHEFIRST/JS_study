                ...
                <form id="updateForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <table class="inputTbl">
                        ...
                        <tr>
                            ...
                            <td><input type="date" class="input short" name="dDate" id="dDate" value="<?php echo $html_values['D_DATE']?>" readonly></td>
                        </tr>
                        <tr>
                    ...
                    <div class="btn-class">
                        ...
                        <button class="btn btn-primary delete wide-btn" 
                            hx-post="licenseDelete.php?saleId=<?php echo $html_values['SALE_ID']; ?>&SN=<?php echo $html_values['SN']; ?>"
                            hx-confirm="정말 삭제하시겠습니까?" hx-swap="outerHTML" hx-target="#updateForm">삭제
                        </button>
