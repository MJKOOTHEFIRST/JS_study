...
while ($row = mysqli_fetch_assoc($result)) {
    $sale_ids[] = "'" . $dbconnect->real_escape_string($row['SALE_ID']) . "'";
}
...
if ($sale_ids) {
    ...
    if ($stmt = $dbconnect->prepare($query)) {
        ...
        die("Prepare failed: (" . $dbconnect->errno . ") " . $dbconnect->error);
    }
}
                  ...
                  <tbody class="main-screen">
                    <?php 
                      ...
                      <tr data-bs-toggle="collapse" data-bs-target="#flush-collapse<?php echo $counter; ?>" aria-expanded="false" aria-controls="flush-collapse<?php echo $counter; ?>">
                          ...
                          <td class="col-2" style="text-align: left; padding-left: 3%;"><?php echo $row['SN']; ?></td>
                          <td class="col-1"><?php echo $row['TYPE']; ?></td>
                          <td class="col-2" style="text-align: right; padding-right: 8%;"><?php echo number_format($row['PRICE'] ?? 0); ?><span>원</span></td>
                          <td class="col-1">
                            <?php 
                          ...
                          <td colspan="12">
                              <div id="flush-collapse<?php echo $counter; ?>" class="collapse accor-style">
                                <table class="detail-table">
                                    ...
                                    ?>
                                  <tr>
                                      <th style="margin-left:10px; font-weight: bold;">영업 :</th>
                                      <td><?php echo !empty($details['BUSINESS_NAME']) ? $details['BUSINESS_NAME'] : '-'; ?></td>
                                  </tr>
                                  <tr>
                                      <th style="margin-left:10px; font-weight: bold;">영업 전화 :</th>
                                      <td><?php echo !empty($details['BUSINESS_CONTACT']) ? $details['BUSINESS_CONTACT'] : '-'; ?></td>
                                    </tr>
                                    <tr>
                                        <th style="margin-left:10px; font-weight: bold;">영업 이메일 :</th>
                                        <td><?php echo !empty($details['BUSINESS_EMAIL']) ? $details['BUSINESS_EMAIL'] : '-'; ?></td>
                                      <td></td>
                                  </tr><br>
                                  <tr>
                                      <th style="margin-left:10px; font-weight: bold;">거래처 :</th>
                                      <td><?php echo !empty($details['CUSTOMER_NAME']) ? $details['CUSTOMER_NAME'] : '-'; ?></td>
                                  </tr>
                                  <tr>
