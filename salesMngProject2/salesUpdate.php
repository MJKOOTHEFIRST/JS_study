...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //디버깅
    // var_dump($totPrice);  // 변수의 타입과 값
    // print_r($totPrice);  // 배열이나 객체의 내용
            ...
            <div class="inputBox mx-auto shadow p-5 mt-4">
                ...
                <form id="updateForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="btn-class">
                        ...
                        <button class="btn btn-primary delete wide-btn" hx-post="salesDelete.php?saleId=<?php echo $html_values['SALE_ID']; ?>" hx-confirm="정말 삭제하시겠습니까?" 
                        hx-swap="outerHTML"  hx-redirect="salesMain.php" hx-target="#updateForm">삭제</button>
                    </div>
                </form>        
            </div>
        </div>
