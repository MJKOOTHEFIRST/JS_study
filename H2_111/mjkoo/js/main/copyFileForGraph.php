...
// color.conf 파일 경로
$colorConfPath = '/home/nstek/h2_system/patch_active/FDC/work/bjy/impedance/selected/color.conf';

// color.conf 파일 내용 생성
$colorConfContent = "color=$color";

// color.conf 파일 작성
file_put_contents($colorConfPath, $colorConfContent);
